...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7332cb4b", Component.options)
  } else {
    hotAPI.reload("data-v-7332cb4b", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-7332cb4b", module.exports)
  }
}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-31a6c8bf", Component.options)
  } else {
    hotAPI.reload("data-v-31a6c8bf", Component.options)
  }
})()}
...
var _vueInfiniteAutoScroll = __webpack_require__(19);

var _vueInfiniteAutoScroll2 = _interopRequireDefault(_vueInfiniteAutoScroll);
...
exports.default = {
    ...
    components: {
        scroller: _vueInfiniteAutoScroll2.default
    },
    created: function created() {
        this.creatData1();
        this.creatData2();
    ...
    methods: {
        creatData1: function creatData1() {
            var self = this;
            for (var i = 0; i < 6; i++) {
                self.listData1.push({
                    txt: '这是第' + (i + 1) + '行数据...'
        ...
        creatData2: function creatData2() {
            var self = this;
            for (var i = 0; i < 6; i++) {
                self.listData2.push({
                    txt: '这是第' + (i + 1) + '行数据...'
        ...
        creatData3: function creatData3() {
            var self = this;
            for (var i = 0; i < 50; i++) {
                self.listData3.push({
                    txt: '这是第' + (i + 1) + '行数据...'
        ...
        creatData4: function creatData4() {
            var self = this;
            for (var i = 0; i < 12; i++) {
                self.listData4.push({
                    txt: '这是第' + ++num + '行数据...'
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-429371df", Component.options)
  } else {
    hotAPI.reload("data-v-429371df", Component.options)
  }
})()}
...
if(false) {
	module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-429371df\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./vue-infinite-auto-scroll.vue", function() {
		var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-429371df\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./vue-infinite-auto-scroll.vue");
...
exports.default = {
    ...
    methods: {
        scroll: function scroll() {
            var self = this;
            var wrap = document.querySelector('.' + self.wrapClass);
            var scroller = document.querySelector('.' + self.scrollerClass);
            if (!scroller) return;
            var translateY = self.getComputedTranslateY(scroller);
            var li = scroller.querySelectorAll('li');
            ...
            if (scroller && li.length) {
                var liHieght = li[0].clientHeight;
                var delLenght = Math.abs(translateY) / liHieght >> 0;
                if (delLenght > 5) {
        ...
        getComputedTranslateY: function getComputedTranslateY(dom) {
            var startY = 0;
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-429371df", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function(props) {
        return [_c('span', {
          domProps: {
            "textContent": _vm._s(props.item.txt)
          }
        })]
      }
    }])
  ...
  }, [_vm._v("option{force:true}")]), _c('span', {
    staticStyle: {
      "color": "green"
    }
  })])
  ...
  }, [_vm._v("option{once:true}")]), _c('span', {
    staticStyle: {
      "color": "green"
    }
  })])
  ...
  }, [_vm._v("option{newFirst:true}")]), _c('span', {
    staticStyle: {
      "color": "green"
    }
  })])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-31a6c8bf", module.exports)
  }
}
